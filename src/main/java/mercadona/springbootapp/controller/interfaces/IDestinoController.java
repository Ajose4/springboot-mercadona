...
public interface IDestinoController {
	...
	@ApiResponses(value = { 
			@ApiResponse(responseCode = "200", description = "Everything is ok", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DestinoResponseDTO.class))),
	...
	ResponseEntity<DestinoResponseDTO> getDestinoByCod(@RequestHeader("access-token") String token, 
			@RequestParam(name = "cod", required = true) String cod) throws RestException;
